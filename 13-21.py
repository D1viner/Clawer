...
class DouYin:
    def __init__(self):
        self.url = 'https://live.douyin.com/942316844036'
        print('正在打开浏览器')
        options = Options()
    ...
    def save_danmus(self):
        ...
        df_danmus.to_csv('./danmu/test.csv', header=0, index=None, encoding="utf_8_sig")
...
if __name__ == '__main__':
    live = DouYin()
    live.run(max_time=6 * 60 * 60, flush_time=5)
